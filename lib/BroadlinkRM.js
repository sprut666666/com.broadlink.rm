...
const learnRFS = require('./learnRFS')
...
class BroadlinkRM {
  ...
  startRFSLearning(mac, progress) {
    learnRFS.start(this.devices[mac], this.log, { progress })
  }

  stopRFSLearning() {
    learnRFS.stop(this.log)
  }
